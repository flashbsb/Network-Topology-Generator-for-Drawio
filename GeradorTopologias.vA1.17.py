...
class TopologyGenerator:
    ...
    def _get_node_style(self, node_data, scale_factor=1.0):
        ...
        scaled_font_size = max(8, int(base_font_size * scale_factor))  # Mínimo 8px
    ...
    def _get_connection_style(self, connection):
        """
        Gera estilo visual para uma conexão
        ...
        style_template.update({
            ...
            "fontSize": connection['fontSize'] or '14',
